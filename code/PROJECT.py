...
def encode():
	...
	fontl = tkFont.Font(family='Cooper Black', size=32,)
	label1=Label(enc,image=img)
	label1.pack()

	LabelTitle=Label(text="ENCODE",bg="aquamarine",fg="black",width=20)
	...
	Button2 = Button(text="SELECT IMAGE",fg="black",bg="orchid1",command=openfile)
	Button2.place(relx=0.7, rely=0.2, height=31, width=94)

	secimg=StringVar()
	radio1=Radiobutton(text='jpeg',fg="black",bg="spring green",value='jpeg',variable=secimg)
	radio1.place(relx=0.7, rely=0.57)
	

	radio2=Radiobutton(text='png',fg="black",bg="spring green",value='png',variable=secimg)
	radio2.place(relx=0.8, rely=0.57)
			



	Label1 =Label(text="ENTER MESSAGE",fg="black",bg="orchid1")
	Label1.place(relx=0.6, rely=0.6, height=21, width=104)
	entrysecmes=Entry()
	entrysecmes.place(relx=0.7, rely=0.6, relheight=0.05, relwidth=0.200)

	Label2 =Label(text="FILE NAME",fg="black",bg="orchid1")
	...
	def encode():
		if secimg.get()=="jpeg":
			inimage=fileopen
			response=messagebox.askyesno("Permission","Do you want to encode")
			if response==1: 
				aaa.hide(inimage,entrysave.get()+'.jpg',entrysecmes.get())
				messagebox.showinfo("Message","Successfully encode to : "+entrysave.get()+".jpeg")


			else:
				messagebox.showwarning("Message","Unsuccessful")
		...
		if secimg.get()=="png":
			...
			if response==1: 
				...
				messagebox.showinfo("Message","Successfully encode to "+entrysave.get()+".png")
	...
	Button2 = Button(text="ENCODE",fg="black",bg="spring green",command=encode)
	Button2.place(relx=0.7, rely=0.8, height=31, width=94)

	Buttonback = Button(text="BACK",fg="black",bg="tomato",command=back)
...
def decode():
	...
	LabelTitle=Label(text="DECODE",bg="PaleVioletRed1",fg="black",width=20)
	LabelTitle['font']=fontl
	LabelTitle.place(relx=0.6, rely=0.1)
	...
	Button2 = Button(text="DECODE",fg="black",bg="spring green",command=deimg)
	Button2.place(relx=0.7, rely=0.8, height=31, width=94)
...
encbutton=Button(text='ENCODE',fg="black",bg="aquamarine",width=20,command=encode)
encbutton['font'] =fontl 
encbutton.place(relx=0.6,rely=0.3)


decbutton=Button(text='DECODE',fg="black",bg="OliveDrab2",width=20,command=decode)
...
closebutton=Button(text='EXIT',fg="black",bg="OrangeRed2",width=20,command=exit)
